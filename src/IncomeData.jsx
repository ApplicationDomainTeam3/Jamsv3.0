...
export const IncomeData = () => {
    ...
    //////Get product sales, cost of goods sold, and overhead expenses
            ...
            //Calculate gross profit and operating profit
                ...
                {
                    document.getElementById("gpm").style.color = "#0dd400";
                    document.getElementById("gpm").style.backgroundColor= "#e0ffde";
                    document.getElementById("gpm").style.opacity = "0.7"; 
                }
                else if(grossProfitMargin*100 > 35 && gpm <= 50)
                {
                    document.getElementById("gpm").style.color = "#e88000";
                    document.getElementById("gpm").style.backgroundColor= "#fadbb4";
                    document.getElementById("gpm").style.opacity = "0.7"; 
                }
                else if(grossProfitMargin* 100 <= 35)
                {
